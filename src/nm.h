...
#define CLIENT_RETRY_INTERVAL 500000 // 0.5 seconds
...
private:
    ...
    volatile bool is_polling_started_;
...
public:
    ...
    int nm_send_and_recv_udp_msg_to_server(struct KVMsg * request, 
        struct KVMsg * reply, uint32_t server_id);
    void close_udp_sock();
